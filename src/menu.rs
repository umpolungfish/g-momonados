...
pub static TOOLS_MENU: &[MenuItem] = &[
    ...
    MenuItem { name: "shiab",                      cmd: "shiab",                     desc: "SHIAB operator: holographic scale-collapse. An integer collapses to its δ boundary with μ∘δ=id recovery and winding; an IMASM word is wrapped as bulk in ⊢⊙∈…⋈∋⊡⊣ and run", example: "shiab 42", submenu: None },
