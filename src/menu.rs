...
pub static TOOLS_MENU: &[MenuItem] = &[
    ...
    MenuItem { name: "shiab",                      cmd: "shiab",                     desc: "SHIAB operator: holographic scale-collapse run live — wrap a word as bulk inside ⊢⊙∈…⋈∋⊡⊣, read its register, closure verdict and integer winding", example: "shiab apply ⊤≺⊥", submenu: None },
